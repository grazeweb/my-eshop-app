...
const legalContent: { [key: string]: { title: string; content: React.ReactNode } } = {
  terms: {
    ...
    content: (
      <div className="space-y-4">
        <p>Welcome to ShopEase. These terms and conditions outline the rules and regulations for the use of ShopEase's Website.</p>
        <h3 className="font-semibold pt-4">1. Introduction</h3>
        <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use ShopEase if you do not agree to take all of the terms and conditions stated on this page.</p>
        <h3 className="font-semibold pt-4">2. Intellectual Property Rights</h3>
        <p>Other than the content you own, under these Terms, ShopEase and/or its licensors own all the intellectual property rights and materials contained in this Website.</p>
  ...
  privacy: {
    ...
    content: (
       <div className="space-y-4">
        <p>Your privacy is important to us. It is ShopEase's policy to respect your privacy regarding any information we may collect from you across our website.</p>
  ...
  returns: {
    ...
    content: (
       <div className="space-y-4">
        <p>Thanks for shopping at ShopEase. If you are not entirely satisfied with your purchase, we're here to help.</p>
